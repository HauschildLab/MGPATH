...
parser.add_argument('--data_graph_dir_s', type=str, default=None, help='dir under data directory' )
parser.add_argument('--data_graph_dir_l', type=str, default=None, help='dir under data directory' )
parser.add_argument('--aug_data_folder_s', type=str, default=None, help='dir under data directory' )
parser.add_argument('--aug_data_graph_dir_s', type=str, default=None, help='dir under data directory' )
parser.add_argument('--aug_data_folder_l', type=str, default=None, help='dir under data directory' )
parser.add_argument('--aug_data_graph_dir_l', type=str, default=None, help='dir under data directory' )
...
parser.add_argument('--ratio_graph', type=float, default=0.2, help='ratio for graph feature')
parser.add_argument('--typeGNN', type=str, default=None, help='type of GNN')
parser.add_argument('--use_gigapath_backbone', action='store_true', default=False, help='use PLIP and Gigapath.')
parser.add_argument('--use_plip_backbone', action='store_true', default=False, help='use PLIP only.')
parser.add_argument('--freeze_text_encoder', action='store_true', default=False, help='freeze text encoder.')
...
if args.task == 'task_tcga_rcc_subtyping':
    ...
    dataset = Generic_MIL_Dataset(
        ...
        data_graph_dir_s = args.data_graph_dir_s,
        data_graph_dir_l = args.data_graph_dir_l,
        shuffle = False,
        print_info = True,
    ...
    args.n_classes=2
    dataset = Generic_MIL_Dataset(
        csv_path = 'dataset_csv/TCGA_BRCA_subtyping.csv',
        data_dir_s = args.data_folder_s,
        data_dir_l = args.data_folder_l,
        data_graph_dir_s = args.data_graph_dir_s,
        data_graph_dir_l = args.data_graph_dir_l,
...
results_dir = args.results_dir
with open(results_dir + f'/experiment_{exp_code}.txt', 'w') as f:
...
def main(args):
    ...
    for i in folds:
        ...
        seed_torch(args.seed)
        print("splits: ", '{}/splits_{}.csv'.format(args.split_dir, i))
